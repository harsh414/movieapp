...
@section('content')
    <div class="movie-info border-b border-gray-800 pt-16">
        <div class="container mx-auto px-4 py-16 flex flex-col items-center md:flex-row">
            <div class="flex-none">
                <img src="{{'https://image.tmdb.org/t/p/w500/'.$show['backdrop_path']}}" alt="poster" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24" x-data="{isOpen:false}">
                ...
                <div class="mt-12">
                    @if(count($show['videos']['results']))
                        <a href="https://www.youtube.com/watch?v={{$show['videos']['results']['0']['key']}}" target="_blank" class="flex items-center bg-gray-400 text-gray-900 rounded font-semibold px-5 py-4
